...
public:
	...
	void KresliKruznicu(QPoint* P1, QPoint* P2, QColor* Color);
	void KresliUseckuDDA(QPoint* P1, QPoint* P2, QColor* Color);
	void KresliUseckuBresen(QPoint* P1, QPoint* P2, QColor* Color);

	void PointSwap(QPoint& P1, QPoint& P2);
